...
const createStyles = (colors) => StyleSheet.create({
  row: { paddingBottom: 4, paddingHorizontal: 16 },
  card: {
  ...
  cardPressable: { alignItems: 'stretch', padding: 10 },
  imgWrap: { position: 'relative' },
  // White tile + 'contain' — see ProductScreen.cardImage note.
  img: { backgroundColor: '#ffffff', borderRadius: 10, height: 110, width: '100%' },
  ...
  name: { color: colors.textPrimary, fontSize: 13, fontWeight: '700', marginTop: 8, minHeight: 34 },
  catRow: { alignItems: 'center', flexDirection: 'row', marginTop: 2 },
  cat: { color: colors.textSecondary, flex: 1, fontSize: 11 },
  empty: { color: colors.textSecondary, fontSize: 13, marginHorizontal: 16 },
  bottom: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 },
  price: { color: colors.brandPrimary, fontSize: 15, fontWeight: '800' },
  priceRow: { alignItems: 'baseline', flexDirection: 'row' },
  dealPrice: { color: '#e23744', fontSize: 16, fontWeight: '800' }, // Shopee flash red
  ...
  originalPrice: { color: '#9aa0a6', flexShrink: 1, fontSize: 11, marginLeft: 6, textDecorationLine: 'line-through' },
  offPct: { color: '#e23744', flexShrink: 1, fontSize: 10, fontWeight: '800', marginLeft: 4 },
  dealChip: {
  ...
  dealChipText: { color: '#e23744', fontSize: 9, fontWeight: '800', letterSpacing: 0.3 },
  stockTagIn: { color: colors.success, fontSize: 10, fontWeight: '700' },
  stockTagLow: { color: '#e67e00', fontSize: 10, fontWeight: '700' },
  stockTagOut: { color: colors.error, fontSize: 10, fontWeight: '700' },
  add: {
    alignItems: 'center',
    backgroundColor: colors.brandPrimary,
    borderRadius: 16,
